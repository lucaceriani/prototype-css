...
export const Options = () => {
  ...
  const [allCssProtosById, setAllCssProtosById] = useState<{
    [id: string]: CSSProto;
  }>({});
  ...
  return (
    <>
      <div
        className="grid"
        style={{ gridTemplateColumns: ".3fr .7fr", paddingBottom: "2rem" }}>
        <div>
          ...
          <div>
            ...
            <button
              onClick={() => {
                ...
                confirm(
                  "If you pull, prototypes with the same id will be overwritten.\nAre you sure?"
                ) &&
                ...
                {(allCssProtosByUrl[urlMatch] || []).map((cssProto) => (
                  <div style={{ paddingLeft: "1rem" }}>
                    <a
                      ...
                      style={{
                        color:
                          cssProto.id == hashId ? "var(--contrast)" : undefined,
                      }}>
                      {cssProto.name}
                    </a>
                  </div>
